  ...
  return (
    <div>
          ...
          <CodeBlocks
            ...
            heading={
              <div className="w-[100%] text-4xl font-semibold lg:w-[50%]">
                Start
                <HighLighText text={"coding"} />
                <br />
                <HighLighText text={"in seconds"} />
              </div>
            }
            subheading={
      ...
      <div className="bg-pure-greys-5 text-richblack-700">
        ...
        <div
          className="mx-auto w-11/12 max-w-maxContent flex flex-col items-center
       justify-between gap-7 "
        >
          {/* Jobs in Demand Section-1 */}
      ...
      >
        ...
        <h2 className="text-center text-4xl font-semibold mt-16">
