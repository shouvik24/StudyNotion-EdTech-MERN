...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      <div
        className="flex items-center justify-between rounded-md sm:flex-col md:flex-row lg:flex-row
      ...
      <div
        className="my-10 flex flex-col gap-y-10 
      rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12"
      >
        <div className="flex w-full items-center justify-between">
          <p className="text-lg font-semibold text-richblack-5">
            Personal Details
        ...
        <div className="flex max-w-maxContent justify-between sm:flex-col sm:gap-y-4 md:gap-y-0 md:flex-row">
          <div className="flex flex-col gap-y-5">
            ...
            <div className="flex sm:flex-col gap-y-5 md:flex md:">
              <div>
          ...
          <div className="flex flex-col gap-y-5 sm:justify-between md:justify-start lg:justify-start">
            <div>
