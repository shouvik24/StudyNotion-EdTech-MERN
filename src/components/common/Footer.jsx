    ...
    text-richblack-400 leading-6 mx-auto relative py-14"
      >
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          {/* Section 1 */}
          <div
            className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r 
      ...
      {/* Section -3 */}
      <div
        className="flex flex-row items-center justify-between w-11/12 max-w-maxContent
      ...
      >
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center">
            Made with ❤️ by Shouvik Mukhopadhyay © 2023 Studynotion
          </div>
        </div>
      </div>
    </div>
...
// <footer className="text-richblack-50 bg-richblue-900">
//   <hr />
...
//       <img
//         src="src\assets\Logo\Logo-Full-Light.png"
